[English](client-arduino.md) | [Русский](../ru/client-arduino.md) | [Contents](../en/README.md)

# Arduino client

Header: [`src/SVArduino/SVClient.h`](../../src/SVArduino/SVClient.h). Copy the library into the Arduino libraries folder and include it in the sketch.

![Libraries folder](../images/arduino-libs.png)

![Include](../images/arduino-include.png)

![Sketch](../images/arduino-code.png)
...
Packets are sent on a timer; you only call `add*Value` from `loop()`.
