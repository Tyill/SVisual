...
public:
    ...
    void setupUi(QWidget *graphPanelClass)
    {
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/SVGp/images/player_stop.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        horizontalSpacer = new QSpacerItem(70, 50, QSizePolicy::Fixed, QSizePolicy::Minimum);
